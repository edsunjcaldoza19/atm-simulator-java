 ...
 * @author Asus
 */
public class registerForm4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Confirm PIN Number: ");

        txtConfirmPin.setBackground(new java.awt.Color(36, 47, 65));
        txtConfirmPin.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        txtConfirmPin.setForeground(new java.awt.Color(255, 255, 255));
        txtConfirmPin.setBorder(null);

        jPanel2.setBackground(new java.awt.Color(0, 153, 153));

        imgIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/imgAdmin.png"))); // NOI18N
        ...
        jLabel4.setText("PLEASE ENTER YOUR CARD NUMBER AND PIN");
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
       int card, pin, confirmpin, newindex = 0;
       card = Integer.parseInt(txtCard.getText());
       pin = Integer.parseInt(txtPin.getText());
       confirmpin = Integer.parseInt(txtConfirmPin.getText());
       for(int i = 0; i < global.counter; i++){
           if(card == global.card[i]){
               newindex = i;
               break;
           }
       }
       if(card == global.card[newindex]){
            JOptionPane.showMessageDialog(null, "Card Number is already taken");
       }
       else{
       if(pin == confirmpin){
           JOptionPane.showMessageDialog(null, "You have sucessfully created an account");
           global.card[global.index] = card;
           global.pin[global.index] = pin;
           global.counter++;
           dispose();
           new signup().setVisible(true);
       }
       else{
           JOptionPane.showMessageDialog(null, "PIN Code does not match");
           txtPin.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(registerForm4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
