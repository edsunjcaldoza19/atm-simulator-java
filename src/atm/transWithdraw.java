 ...
 * @author Asus
 */
public class transWithdraw extends javax.swing.JFrame{

    /**
     * Creates new form transDeposit
     */
    public transWithdraw() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/imgTrans3.png"))); // NOI18N
        ...
        jLabel1.setText("PLEASE ENTER AN AMOUNT TO WITHDRAW");

        txtWithdraw.setBackground(new java.awt.Color(58, 56, 77));
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
        msgs obj = new msgs();
        formulas obj1 = new formulas();
        double withdraw;
        withdraw = Double.parseDouble(txtWithdraw.getText());
        global.withdraw[global.index] = withdraw;
        if(global.withdraw [global.index] <= global.balance [global.index]) {
           obj1.withdraw();
           dispose();
        }
        else{
